...
\begin{document}
\begin{tikzpicture}
	\node[inputNode, thick] (i1) at (6, 0.25) {};
	\node[inputNode, thick] (i2) at (6, -0.25) {};
	%\node[inputNode, thick] (i3) at (6, -0.75) {};
	
	\node[inputNode, thick] (h1) at (8, 0.75) {};
	\node[inputNode, thick] (h2) at (8, 0.0) {};
	\node[inputNode, thick] (h3) at (8, -0.75) {};
	...
	\draw[stateTransition] (5, 0.25) -- node[above] {$x_1$} (i1);
	\draw[stateTransition] (5, -0.25) -- node[above] {$x_2$} (i2);
	...
	\node[] (l1) at (6,1.2) {$W_1$};
	\node[] (l2) at (8,1.2) {$W_2$};
	\node[] (l3) at (10,1.2) {$W_3$};
	
    \draw[stateTransition] (o1) -- node[above] {$O_1$} (11, 0.0);
